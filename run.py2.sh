...
pip install ipython numpy jupyter statistics matplotlib pandas seaborn scipy scikit-learn sympy plotly wordcloud pillow mlxtend SPARQLWrapper graphviz statsmodels patsy #--upgrade
